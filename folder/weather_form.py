...
class WeatherApp:
    def __init__(self):
        ...
        self.button_run = Button(text='Выполнить', width=20, command=self.get_result)
        self.button_run.place(x=5, y=320)
        self.button_close = Button(text='Закрыть', width=20, command=self.window.destroy)
        self.button_close.place(x=190, y=320)
